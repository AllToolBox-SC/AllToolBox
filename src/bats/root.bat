...
menu.exe .\menu\root.json
set /p MENU=<menutmp.txt
if "%MENU%"=="1" call rebootpro qmmi otherpash I12 && goto EDL_run
if "%MENU%"=="2" call rebootpro qmmi otherpash IB && goto EDL_run
if "%MENU%"=="3" call rebootpro qmmi otherpash I13C && goto EDL_run
if "%MENU%"=="4" call rebootpro qmmi otherpash I13 && goto EDL_run
if "%MENU%"=="5" call rebootpro qmmi otherpash I19 && goto EDL_run
if "%MENU%"=="6" call rebootpro qmmi otherpash I18 && goto EDL_run
if "%MENU%"=="7" call rebootpro qmmi v3pash I20 && goto EDL_run
if "%MENU%"=="8" call rebootpro qmmi v3pash I25 && goto EDL_run
if "%MENU%"=="9" call rebootpro qmmi v3pash I25C && goto EDL_run
if "%MENU%"=="10" call rebootpro qmmi v3pash I25D && goto EDL_run
if "%MENU%"=="11" call rebootpro qmmi v3pash I32 && goto EDL_run
if "%MENU%"=="12" call rebootpro qmmi v3pash ND07 && goto EDL_run
if "%MENU%"=="13" call rebootpro qmmi v3pash ND01 && goto EDL_run
if "%MENU%"=="14" CLS&&call nd03root&&exit /b
...
ECHO %INFO%开始准备文件
if not exist .\EDL\%innermodel%.zip call cloud innermodel
7z x EDL\%innermodel%.zip -o.\EDL\rooting -aoa >nul 2>&1
if %errorlevel% neq 0 (
